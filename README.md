...
Por otro lado, si se quiere hacerlo mediante el registro en Google, debe seguir los siguientes pasos:
Paso 1: Pulsar el botón de "Acceder" y añadir el usuario y contraseña deseado.
Paso 2: Pulsar el botón de "Autorización" y permitir a la App usar y modificar datos de su Google Drive.
Paso 3: Cargar los archivos como anteriormente.
