...
## Cómo probar al aplicación y recomendaciones de uso
 ...
 Si se quiere usar sin hacer el resgistrarse en Google, simplemente, el usuario debe arrastrar y soltar el archivo en la zona del "Drop a File!" identificada con la iamgen de una carpeta, o bien, puede hacerlod de la manera tracional, usando el botón de "Agregar archivo".
 
## Stack | 

Los lenguajes utiliazado han sido: JavaScript, HTML, CSS3 y la librería de Pico.css
Mi intención al utilizar JS puro ha sido que pudiera servir de ejemplo para alguien que está aprendiendo JavaScript y aún no conoce ningún framework.
